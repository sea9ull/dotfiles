...
local language = {
    ...
    ['jp'] = {
        welcome = '{\\fs24\\1c&H0&\\3c&HFFFFFF&}ここにファイルまたはURLをドロップしてください',
        off = 'OFF',
        na = 'n/a',
        none = '無',
        video = '動画',
...
local osc_styles = {
    TransBg = '{\\blur80\\bord110\\1c&H000000&\\3c&H000000&}',
    ...
    Ctrl4 = '{\\blur0\\bord0\\1c&HFFFFFF&\\3c&H888888&\\fs24\\fnmaterial-design-iconic-font}',
    ...
    -- WCBg = '{\\blur40\\bord30\\1c&H000000&\\3c&H000000&}',
    WinCtrl = '{\\blur0.2\\bord1\\1c&HFFFFFF&\\3c&H444444&\\fs20\\fnmaterial-design-iconic-font}',
    Title = '{\\blur0.2\\bord1\\1c&HFFFFFF&\\3c&H444444\\fs16\\q2\\fn' .. user_opts.font .. '}',
...
function window_controls()
    ...
    local controlbox_w = wc_geo.w
    local controlbox_left = wc_geo.w - controlbox_w
    local controlbox_right = controlbox_left + controlbox_w
    ...
    -- new_element('WCBg', 'box')
    -- lo = add_layout('WCBg')
    -- lo.geometry = {x = 0, y = 0, an = 7, w = wc_geo.w, h = 1}
    -- lo.style = osc_styles.WCBg
    -- lo.layer = 10
    -- lo.alpha[3] = 0

    local speeds = {"1.0","1.2","1.5","2.0"}
    -- spd_ctrl
    ne = new_element('spd_ctrl', 'button')
    ne.content = ''
    ne.tooltip_style = osc_styles.Tooltip
    ne.tooltip_an = 2
    ne.tooltipF = function ()
        return (string.format("x%4.1f", mp.get_property_number("speed", -1)))
    end
    ne.softrepeat = false
    ne.eventresponder['mbtn_left_down'] =
        function () mp.commandv('cycle-values', 'speed', unpack(speeds)) end
    ne.eventresponder['mbtn_right_down'] =
        function () mp.commandv('cycle-values', '!reverse', 'speed', unpack(speeds)) end
    ne.eventresponder['mbtn_mid_down'] =
        function () mp.commandv('set', 'speed', '1.0') end
    lo = add_layout('spd_ctrl')
    lo.geometry = {x = 20, y = button_y, an = 5, w = 24, h = 24}
    ...
    lo = add_layout('close')
    lo.geometry = {x = controlbox_right - 20, y = button_y, an = 5, w = 40, h = wc_geo.h}
    lo.style = osc_styles.WinCtrl
    lo.alpha[3] = 128
    ...
    ne.content = function()
        -- return state.fullscreen and '\xEF\x85\xAC' or '\xEF\x85\xAD'
        return state.fullscreen and '' or ''
    end
    ne.eventresponder['mbtn_left_up'] =
        function ()
    ...
    lo.geometry = {x = controlbox_right - 50, y = button_y, an = 5, w = 40, h = wc_geo.h}
    lo.style = osc_styles.WinCtrl
    lo.alpha[3] = 128
...
layouts = function ()
    ...
    add_area('showhide_wc', 0, 0, osc_param.playresx, 48)
    ...
    lo.geometry = {x = refX , y = refY - 86 , an = 5, w = osc_geo.w - 50, h = 2}
    lo.layer = 13
    ...
    lo.geometry = {x = refX, y = refY - 86 , an = 5, w = osc_geo.w - 50, h = 16}
    ...
    lo.geometry = {x = 25, y = refY - 74, an = 7, w = 64, h = 20}
    lo.style = osc_styles.Time    

    lo = add_layout('tc_right')
    lo.geometry = {x = osc_geo.w - 25 , y = refY - 74, an = 9, w = 64, h = 20}
    lo.style = osc_styles.Time    


    -- buttons
    lo = add_layout('pl_prev')
    lo.geometry = {x = refX - 100, y = refY - 40 , an = 5, w = 30, h = 24}
    lo.style = osc_styles.Ctrl2

    lo = add_layout('skipback')
    lo.geometry = {x = refX - 50, y = refY - 40 , an = 5, w = 30, h = 24}
    lo.style = osc_styles.Ctrl2
    ...
    lo.geometry = {x = 37, y = refY - 30, an = 5, w = 24, h = 24}
    lo.style = osc_styles.Ctrl3
    lo.visible = (osc_param.playresx >= 600)

    lo = add_layout('cy_audio')
    lo.geometry = {x = 82, y = refY - 30, an = 5, w = 24, h = 24}
    lo.style = osc_styles.Ctrl3
    lo.visible = (osc_param.playresx >= 600)

    lo = add_layout('toggle_repeat')
    lo.geometry = {x = 127, y = refY - 30, an = 5, w = 24, h = 24}
    lo.style = osc_styles.Ctrl3
    lo.visible = (osc_param.playresx >= 600)

    lo = add_layout('toggle_info')
    lo.geometry = {x = 172, y = refY - 30, an = 5, w = 24, h = 24}
    lo.style = osc_styles.Ctrl3
    lo.visible = (osc_param.playresx >= 720)
    ...
    lo.geometry = {x = osc_geo.w - 127, y = refY - 30, an = 5, w = 24, h = 24}
    lo.style = osc_styles.Ctrl3
    lo.visible = (osc_param.playresx >= 600)

    lo = new_element('volumebarbg', 'box')
    lo.visible = (osc_param.playresx >= 600) and user_opts.volumecontrol
    lo = add_layout('volumebarbg')
    lo.geometry = {x = osc_geo.w - 105, y = refY - 30, an = 4, w = 80, h = 2}
    lo.layer = 13
    lo.style = osc_styles.VolumebarBg

    lo = add_layout('volumebar')
    lo.geometry = {x = osc_geo.w - 105, y = refY - 30, an = 4, w = 80, h = 8}
...
function osc_init()
    ...
    ne.content = function ()
        return mp.get_property('pause') == 'no' and '\xEF\x8E\xA7' or '\xEF\x8E\xAA'
    end
    ne.eventresponder['mbtn_left_up'] =
    ...
    ne.visible = (osc_param.playresx >= 600) and user_opts.volumecontrol
    ne.content = function ()
        return state.mute and '\xEF\x8E\xBB' or '\xEF\x8E\xBC'
    end
    ne.eventresponder['mbtn_left_up'] =
    ...
    -- ne.content = function () return state.fullscreen and '\xEF\x85\xAC' or '\xEF\x85\xAD' end
    -- ne.visible = (osc_param.playresx >= 540)
    -- ne.eventresponder['mbtn_left_up'] = function () mp.commandv('cycle', 'fullscreen') end

    -- toggle_repeat
    ne = new_element('toggle_repeat', 'button')
    ne.content = function()
        return mp.get_property('loop-file') == 'inf' and '' or ''
    end
    ne.visible = (osc_param.playresx >= 600)
    ne.tooltip_style = osc_styles.Tooltip
    ne.tooltip_an = 2
    ne.tooltipF = function () return mp.get_property('loop-file') == 'inf' and 'repeat-on' or 'repeat-off' end
    ne.eventresponder['mbtn_left_up'] =
        function () mp.commandv('cycle-values', 'loop-file', 'inf', 'no') end

    --toggle_info
    ne = new_element('toggle_info', 'button')
    ne.content = ''
